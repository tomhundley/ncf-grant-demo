        ...
        {grants.map((grant: any) => (
          ...
          >
            ...
            <div className="pl-3">
              ...
              <div className="text-2xl font-serif font-bold text-electric-blue-600 dark:text-electric-blue-400 mb-2">
              ...
              <div className="flex items-center text-xs text-slate-500 mb-4 border-t border-black/5 dark:border-white/5 pt-3">
      ...
      <div className="hidden md:block glass-panel overflow-hidden">
        <table className="min-w-full divide-y divide-black/10 dark:divide-white/10">
          ...
          <tbody className="divide-y divide-black/10 dark:divide-white/10">
            {grants.map((grant: any) => (
              <tr key={grant.id} className="hover:bg-black/5 dark:hover:bg-white/5 transition-colors">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-lg font-serif text-electric-blue-600 dark:text-electric-blue-400 font-bold">
                  {formatCurrency(grant.amount)}
                </td>
