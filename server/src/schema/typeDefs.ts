 ...
 * =============================================================================
 *
 * This file defines the complete GraphQL schema for the Ministry Grant
 * Management system. It demonstrates:
 *
 *   - Scalar types with custom validation (DateTime, Decimal)
 *   - Enum types for type-safe status management
 *   - Input types for mutations with clear structure
 *   - Connection pattern for pagination
 *   - Comprehensive query and mutation operations
 *   - Nested object relationships
 *
 * The schema follows GraphQL best practices:
 *   - Nullable fields are explicit (no ! means nullable)
 *   - Input types separate from output types
 *   - Meaningful descriptions on all types and fields
